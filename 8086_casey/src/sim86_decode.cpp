...
instruction DecodeInstruction(disasm_context *Context, memory *Memory, segmented_access *At)
{
    ...
    instruction Result = {};
    u32 InstructionFormatsCount = ArrayCount(InstructionFormats);
    printf("InstructionFormatsCount %d\n",InstructionFormatsCount);
    for(u32 Index = 0; Index < InstructionFormatsCount; ++Index)
    {
        printf("Index: %d\n",Index);
